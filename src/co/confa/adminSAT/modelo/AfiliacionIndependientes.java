...
public class AfiliacionIndependientes {
	...
	public AfiliacionIndependientes() {
		
	}

	public AfiliacionIndependientes(String numeroRadicadoSolicitud, String numeroTransaccion, String tipoAfiliado,
			...
			String fechaSolicitud, String fechaEfectivaAfiliacion, String departamento, String municipio, String pais,
			String ciudad, String direccionDomicilio, String estadoCivil, String numeroTelefono,
			String correoElectronico, String valorMensualIngresos, String perdidaAfiliacionCausaGrave,
			String declaracionFuenteIngresos, String declaracionVeracidadInformacion, String codigoCCF, String pazSalvo,
			String fechaPazSalvo, String autorizacionManejoDatos, String autorizacionNotificaciones,
