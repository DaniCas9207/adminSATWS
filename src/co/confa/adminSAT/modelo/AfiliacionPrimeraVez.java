...
public class AfiliacionPrimeraVez {
	...
	public AfiliacionPrimeraVez() {
	}
	
	public AfiliacionPrimeraVez(String numeroRadicadoSolicitud, String numeroTransaccion, String tipoPersona,
			...
			String autorizacionNotificaciones, String manifestacion, String estadoConfa) {
		super();
